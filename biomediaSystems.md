...
- Wolfe's analysis of systems theory gets at systems' potential to grow from closed systems to open systems back to larger closed systems as environmental complexities open up and are subsumed by the system that closes in on these broader territorial boundaries. This is beacuse of the indexical nature that systems demand and their inevitable external, environmental complexities that are not indexed until they become part of the system. The very act of indexing and identifying parts of the system's environment connects those agents to the system.
